...
import { company, footerNav, legalLinks } from '../../data/navigation';
        ...
        <div className="grid gap-12 lg:grid-cols-12">
          <div className="lg:col-span-4">
            ...
            <p className="mt-5 max-w-sm text-sm leading-relaxed text-white/65">
              {company.name} designs and develops modern digital solutions across web, mobile, and AI. {company.tagline}
            </p>
